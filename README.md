...
npm run cc:start -- convoracle
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke convoracle convoracle_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- convoracle org1
# Install to your blockchain - From the root of your project
hurl install convoracle node -P ./chaincode-convoracle
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install convoracle node -P ./chaincode-convoracle --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade convoracle node 1.2 -P ./chaincode-convoracle
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- convoracle 1.2
```
